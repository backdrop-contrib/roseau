...
((Drupal) => {
  const { isDesktopNav } = Drupal.roseau;
  ...
  Drupal.roseau.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.roseau.isDesktopNav()) return;
  ...
  Drupal.roseau.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.roseau.areAnySubNavsOpen = areAnySubNavsOpen;
