...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.roseau.areAnySubNavsOpen()) {
          props.roseau.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.roseauNavigation = {
    attach(context) {
