...
/**
 * @file
 * Functions to support theming in the Roseau theme.
 */
 ...
 */
function roseau_preprocess_page_title(&$variables) {
 ...
 */
function roseau_preprocess_maintenance_page(&$variables) {
  ...
  // Roseau has custom styling for the maintenance page.
  $variables['#attached']['library'][] = 'roseau/maintenance-page';
}

/**
 * Implements hook_preprocess_HOOK() for node.html.twig.
 */
function roseau_preprocess_node(&$variables) {
 ...
 */
function roseau_preprocess_block(&$variables) {
 ...
 */
function roseau_theme_suggestions_menu_alter(&$suggestions, array $variables) {
 ...
 */
function roseau_preprocess_menu(&$variables) {
  if (isset($variables['attributes']['region'])) {
 ...
 */
function roseau_theme_suggestions_form_alter(array &$suggestions, array $variables) {
 ...
 */
function roseau_theme_suggestions_block_alter(&$suggestions, array $variables) {
  if (!empty($variables['elements']['#id'])) {
...
function roseau_preprocess_menu_local_tasks(&$variables) {
  if (!empty($variables['primary'])) {
    foreach (element_children($variables['primary']) as $key) {
      ...
      $variables['primary'][$key]['#link']['localized_options']['attributes']['class'][] = 'tabs__link js-tabs-link';
      if (!empty($variables['primary'][$key]['#active'])) {
        $variables['primary'][$key]['#link']['localized_options']['attributes']['class'][] = 'is-active';
      }
    }
  }
  if (!empty($variables['secondary'])) {
    foreach (element_children($variables['secondary']) as $key) {
      $variables['secondary'][$key]['#level'] = 'secondary';
      $variables['secondary'][$key]['#link']['localized_options']['attributes']['class'][] = 'tabs__link js-tabs-link';
      if (!empty($variables['secondary'][$key]['#active'])) {
        $variables['secondary'][$key]['#link']['localized_options']['attributes']['class'][] = 'is-active';
      }
    }
  }
}
 ...
 */
function roseau_preprocess_form_element(&$variables) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_form_element_label(&$variables) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_textarea(&$variables) {
  $variables['attributes']['class'][] = 'form-element';
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_select(&$variables) {
  $variables['attributes']['class'][] = 'form-element';
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_checkboxes(&$variables) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_radios(&$variables) {
  $variables['attributes']['class'][] = 'form-boolean-group';
}
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_field(&$variables) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_field_multiple_value_form(&$variables) {
 ...
 */
function roseau_preprocess_menu_local_task(&$variables) {
 ...
 */
function roseau_preprocess_fieldset(&$variables) {
 ...
 */
function roseau_theme_suggestions_user_alter(&$suggestions, $variables) {
 ...
 * Implements hook_preprocess_HOOK().
 */
function roseau_preprocess_field__node__created(&$variables) {
 ...
 */
function roseau_preprocess_filter_caption(&$variables) {
 ...
 */
function roseau_form_node_preview_form_select_alter(&$form, &$form_state, $form_id) {
 ...
 */
function roseau_preprocess_field__comment(&$variables) {
  // Add a comment_count.
 ...
 */
function roseau_preprocess_text_format_wrapper(&$variables) {
 ...
 */
function roseau_preprocess_search_result(&$variables) {
  // Apply custom date formatter to "date" field.
  if (!empty($variables['result']['date'])) {
    $variables['info_date'] = \Drupal::service('date.formatter')->format($variables['result']['node']->getCreatedTime(), 'roseau_medium');
  }
}
 ...
 */
function roseau_form_views_exposed_form_alter(&$form) {
 ...
 * @internal
 */
function _roseau_hex_to_hsl(string $hex_string) {
