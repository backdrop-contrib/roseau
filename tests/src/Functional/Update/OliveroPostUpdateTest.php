...
namespace Drupal\Tests\roseau\Functional\Update;

use Drupal\FunctionalTests\Update\UpdatePathTestBase;

/**
 * Tests the update path for Roseau.
 *
 * @group Update
 */
class RoseauPostUpdateTest extends UpdatePathTestBase {
   ...
   */
  public function testRoseauPrimaryColorUpdate() {
    $config = $this->config('roseau.settings');
