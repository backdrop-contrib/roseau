...
namespace Drupal\Tests\roseau\Unit;

use Drupal\Tests\UnitTestCase;

/**
 * Tests the _roseau_hex_to_hsl() function.
 *
 * @group roseau
 */
final class RoseauHexToHslTest extends UnitTestCase {
  ...
  public function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../roseau.theme';
  }
  ...
  public function testHexToHsl(string $hex, array $expected_hsl): void {
    self::assertEquals($expected_hsl, _roseau_hex_to_hsl($hex));
  }
